...
import com.example.xpensor.databinding.ActivityDetailedBinding
...
class DetailedActivity : AppCompatActivity() {
    ...
    private fun setupListeners() {
        with(binding) {
            ...
            labelInputEdit.addTextChangedListener { clearError(labelLayoutEdit) }
            amountInputEdit.addTextChangedListener { clearError(amountLayoutEdit) }
        ...
        when {
            ...
            amount == null -> binding.amountLayoutEdit.error = "Please enter a valid amount"
                ...
                val transaction = Transaction(
                    intent.getIntExtra("transactionId", -1),
                    label, finalAmount, description, date
                )
